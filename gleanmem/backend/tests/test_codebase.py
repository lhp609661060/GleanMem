...
from gleanmem.core.codebase.analyzer import CardDraft, _parse_card_json
...
from gleanmem.core.models import CodebaseRun, WikiDocument
...
def test_parse_card_json_logs_warning_on_invalid_json(caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="gleanmem.core.codebase.analyzer"):
