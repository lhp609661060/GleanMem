...
<template>
  ...
  <div class="card" style="padding: 0">
    ...
    <div v-else-if="!loading" class="empty">
      暂无知识卡。运行 <span class="mono">gleanmem-distill run &lt;repo&gt; --key …</span> 生成。
    </div>
  </div>
</template>
